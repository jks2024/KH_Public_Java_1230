...
public class StreamEx7 {
    public static void main(String[] args) {
        ...
        OptionalInt rst2 = stream4.sorted().findAny(); // 정렬 이후 첫번째 값을 가져 옴 (병렬 처리시에는 결과가 달라 질 수 있음)
        ...
        // 요소의 통계
        // count() : 해당 스트림 요소의 총 개수를 long 타입의 값으로 반환
        ...
        // 요소의 연산
        // sum() : 합계
        // average() : 평균값을 구하는 Optional 객체로 반환
        IntStream stream11 = IntStream.of(30, 90, 70, 10);
        DoubleStream stream12 = DoubleStream.of(30.3, 90.9, 707, 45,56);
